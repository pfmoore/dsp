...
game_items = {
    ...
    [1141] = {
        name='Accelerant Mk.I',
        type='MATERIAL',
        grid_index=1406,
        stack_size=100,
        description='Use a spray coater to spray on the cargo can speed up the rate of manufacturing.',
        disabled=true,
        --image='accelerator-1'
    },
    [1142] = {
        name='Accelerant Mk.II',
        type='MATERIAL',
        grid_index=1506,
        stack_size=100,
        description='Based on Mk.I, the raw material formula is upgraded, which can further increase the rate of manufacturing.',
        disabled=true,
        --image='accelerator-2'
    },
    [1143] = {
        name='Accelerant Mk.III',
        type='MATERIAL',
        grid_index=1606,
        stack_size=100,
        description='Maximize the manufacturing speed with the newly upgraded raw material formula, and the requirements for the entire production line are also higher.',
        disabled=true,
        --image='accelerator-3'
    },
    [1201] = {
    ...
    [2313] = {
        ...
        can_build=true,
        build_index=510,
        description='Spraying Accelerants on cargo can speed up the manufacturing.',
        disabled=true,
        --image='spray-coater'
    },
    [2314] = {
...
game_techs = {
    {
        ...
        image='1151',
        position={17.0, -31.0},
        description='The invention of Accelerant is incredibly useful! Just spray it on cargo to substantially improve industrial production efficiency.',
        conclusion='You have unlocked the Accelerant MK.I, and now you can use the spray coater to spray the accelerant on the cargo to improve the production rate.',
        disabled=true,
    },{
        id=1152,
        name='Accelerant Mk.II',
        ...
        image='1152',
        position={29.0, -31.0},
        description='If the accelerant MK.I is not fast enough for you, then try Accelerant MK.II!',
        conclusion='You have unlocked the Accelerant MK.II, and if you spray it on the cargo, the production rate will increase even more.',
        disabled=true,
    },{
        id=1153,
        name='Accelerant Mk.II',
        ...
        image='1153',
        position={37.0, -31.0},
        description='Accelerant MK. III greatly maximizes the production speed and has higher requirements for the design of the entire production line.',
        conclusion='You have unlocked the Accelerant MK.III, which can maximize the production rate, but it also needs to guarantee enough raw materials.',
        disabled=true,
    },{
        id=1201,
        ...
        image='1505',
        position={49.0, 1.0},
        description="With the Graviton lens, it can increase the ray receiver's maximum output power by utilizing the planetary ionosphere. Of course, the premise is that the planet has an atmosphere, or this technology is useless.",
        ...
        image='3301',
        position={9.0, -23.0},
        description='Increase the cargo stacking for sorters Mark III.',
        ...
        conclusion='The logistics vessels can warp, but need to consume <span style="color:#FD965ECC">Space warper</span>.',
    },{
        id=3405,
        name='Logistics Carrier Engine',
        hash_needed=360000,
        ...
        conclusion='Logistics drones can transport more cargo each time.',
    },{
        id=3502,
        name='Logistics Carrier Capacity',
        hash_needed=108000,
        ...
        conclusion='Logistics vessels and logistics drones can transport more cargo each time.',
    },{
        id=3504,
        name='Logistics Carrier Capacity',
        hash_needed=300000,
